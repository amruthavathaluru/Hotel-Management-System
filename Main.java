...
class holder implements Serializable
{
    ...
    Singleroom suite_room[] = new Singleroom[5];
...
class Hotel
{
        ...
        gender2 = sc.next();
          ...
          switch (i) {
            ...
            case 4:hotel_ob.deluxe_singleerrom[rn]=new Singleroom(name,contact,gender);
                break;
            case 5:hotel_ob.suite_room[rn] = new Singleroom(name, contact, gender);
                break;
    ...
    static void bookroom(int i)
    {
        ...
        switch (i) {
            ...
            case 4:
                ...
                break;
            case 5:
            for (j = 0; j < hotel_ob.suite_room.length; j++) 
            {
                if (hotel_ob.suite_room[j]==null) 
                {
            ...
            try {
                rn = sc.nextInt();
                rn = rn-51;
                if (hotel_ob.suite_room[rn] != null)
                    throw new NotAvailable();
                CustDetails(i, rn);
            } catch (Exception e) {
                System.out.println("Invalid Option");
    ...
    static void bill(int rn,int rtype)
    {
        ...
        switch(rtype)
        {
            ...
            case 4:amount+=1200;
                ...
                break;
             case 5:amount+=7000;
                    System.out.println("Room Charge - "+7000);
                    System.out.println("\nFood Charges:- ");
                    System.out.println("===============");
                    System.out.println("Item   Quantity    Price");
                    System.out.println("-------------------------");
                    for(Food obb: hotel_ob.suite_room[rn].food)
                    {
                        amount+=obb.price;
                        String format = "%-10s%-10s%-10s%n";
                        System.out.printf(format,list[obb.itemno-1],obb.quantity,obb.price );
    ...
    static void deallocate(int rn,int rtype)
    {
        ...
        switch (rtype) {
            ...
            case 5:
                if(hotel_ob.suite_room[rn]!=null)
                    System.out.println("Room used by "+hotel_ob.suite_room[rn].name);                
                else 
                 {    
                    System.out.println("Empty Already");
                        return;
    ...
    static void order(int rn,int rtype)
    {
        ...
        do
        {
            ...
            if (hotel_ob.suite_room[rn] != null) 
            {
				hotel_ob.suite_room[rn].food.add(new Food(i, q));
			} else 
			{
